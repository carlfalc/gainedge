...
export default function RonPulse() {
  ...
  // Keep the hero focused on persisted RON evaluation context. News and
  // session commentary have dedicated screens and do not belong in this summary.
  const visibleItems = items
    .filter((item) => item.kind === "ron_state" || item.kind === "data_health")
    .slice(0, 1);
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        <div>
          ...
          <span style={{ fontSize: 13, color: C.sec, marginLeft: 8 }}>Completed 15-minute evidence</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <button
            ...
            style={{
              ...
              color: C.sec, cursor: "pointer", fontSize: 12, fontWeight: 700,
            }}
          >
