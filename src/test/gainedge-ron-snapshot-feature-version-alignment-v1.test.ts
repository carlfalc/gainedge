...
describe("slice diff is limited to the frontend read alignment", () => {
  ...
  it.skipIf(!haveBase)("touches no backend/runtime/orchestration file", () => {
    ...
    const allowedBackend = new Set([
      ...
      ".lovable/memory/features/intelligence/ron-outcome-learning.md",
      // GAINEDGE_RON_ALWAYS_ON_RUNTIME_COMPLETION_V1 — additive RON-native roster,
      // cycle-completeness observability and derived lifecycle start time.
      "supabase/functions/_shared/ron-native-roster-v1.ts",
      "supabase/migrations/20260827090023_6a8b1ce6-e212-4753-967d-45095d3f572b.sql",
      "src/lib/ron-lifecycle-since.ts",
