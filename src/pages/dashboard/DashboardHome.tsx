    ...
    <div style={{ width: "100%", maxWidth: 1480, margin: "0 auto" }}>
      <header style={{
        ...
        <div>
          ...
          <h1 style={{ color: C.text, fontSize: 24, fontWeight: 700, margin: "5px 0 2px" }}>
            Stored decision records
          </h1>
          <p style={{ color: C.sec, fontSize: 14, margin: 0 }}>
      ...
      <div style={{
        fontSize: 12, color: C.sec, letterSpacing: 1.4, textTransform: "uppercase",
